...
Once you have completed the project, please share the resulting project with us using a public github repo.  In the interview, we will go through the code and discuss your decisions.  If you use AI to generate any code in the project, please be sure that you understand the code and can explain it.  We may ask you to make changes to the code during the interview, so please be sure that you are comfortable with the code you have written.
...
6. Any data processing should be done off the main thread.
